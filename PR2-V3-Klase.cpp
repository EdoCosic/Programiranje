...
public:
    ...
    void Ispis()
    {
        ...
        cout << endl;
        cout << "Spol: " << (*_spol ? "Musko" : "Zensko") << endl;
    }
    //Z2.7
    ~Glumac()
    {
...
public:
    ...
    void ProsiriNizOcjena(int prosiriZa)
    {
        ...
        int* noviNiz = new int[_maxBrojOcjena + prosiriZa];
    ...
    {
        if (_trenutnoOcjena == 0) return false;
        _ocjene[_trenutnoOcjena - 1] = 0;
        _trenutnoOcjena--;
        return true;
    }
    //Z3.10
    float GetProsjecnaOcjena()
    {
        ...
        {
            prosjek = prosjek + _ocjene[i];
        }

        prosjek = prosjek / _trenutnoOcjena;
        return prosjek;
    }
    //Z3.11
    void Ispis() {
